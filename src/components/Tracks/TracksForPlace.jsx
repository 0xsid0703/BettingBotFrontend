                            ...
                            return (
                                <div className='flex flex-row border-d border-t border-grey-2' key={idx}>
                                    <div className='track-body-header justify-between' style={{width: `${pWidth/6}px`}}>
                                        ...
                                        <div className={clsx(`flex flex-row items-center justify-center ${CONDITION_COLOR[event['condition']]} text-white rounded-md text-xs px-[13px] py-0.5 w-[55px] h-[24px]`)}>{event['condition'] === "SYNTHETIC" ? "SYNTH" : event['condition']}</div>
                                    </div>
                                    {
